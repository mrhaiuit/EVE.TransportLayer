...
using EVE.ApiModels.Authentication.Response;
...
namespace EVE.TransportLayer
{
    ...
    {
        Task<ClientResponse<LoginUser>> Login(string userName,
                                                  string passWord);
    ...
    public class ApiAuthentication : IApiAuthentication
    {
        ...
        public async Task<ClientResponse<LoginUser>> Login(string userName,
                                                               string passWord)
        {
            var logonResponse = await HttpUtils<ClientResponse<LoginUser>>
